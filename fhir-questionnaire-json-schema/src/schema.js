...
const responseToJSONSchema = (questionnaireResponse) => {
    ...
    for (const item of questionnaireResponse.item) {
        ...
        properties[item.linkId] = (0, fields_1.valueFieldToValue)(answerObj);
    }
    return properties;
};
...
const generateUISchemaItem = (item) => {
    ...
    const unitExtension = (_a = item.extension) === null || _a === void 0 ? void 0 : _a.find((extension) => extension.url ===
        "http://hl7.org/fhir/StructureDefinition/questionnaire-unit");
    if (unitExtension) {
        if ((_b = unitExtension === null || unitExtension === void 0 ? void 0 : unitExtension.valueCoding) === null || _b === void 0 ? void 0 : _b.code) {
            entry["ui:placeholder"] = (_c = unitExtension === null || unitExtension === void 0 ? void 0 : unitExtension.valueCoding) === null || _c === void 0 ? void 0 : _c.code;
        }
    }
    if (item.item) {
        ...
        for (const display of displays) {
            const displayExtension = (_d = display.extension) === null || _d === void 0 ? void 0 : _d.find((e) => e.url ===
                "http://hl7.org/fhir/StructureDefinition/questionnaire-itemControl");
            if ((_f = (_e = displayExtension === null || displayExtension === void 0 ? void 0 : displayExtension.valueCodeableConcept) === null || _e === void 0 ? void 0 : _e.coding) === null || _f === void 0 ? void 0 : _f.find((e) => e.code === "help")) {
